...
repr_lemmas_pv_msa:
	python create_repr_lemmas_list.py -config_file config.json -config_name pv_msa_order-v4_red -output_name repr_lemmas_pv_msa.pkl -output_dir conjugation_local/repr_lemmas -pos_type verbal -display_format expanded -bank_dir conjugation_local/banks -bank_name MSA-PV-Bank
repr_lemmas_iv_msa:	
	python create_repr_lemmas_list.py -config_file config.json -config_name iv_msa_order-v3 -output_name repr_lemmas_iv_msa.pkl -output_dir conjugation_local/repr_lemmas -pos_type verbal -display_format expanded -bank_dir conjugation_local/banks -bank_name MSA-IV-Ind-Bank
repr_lemmas_cv_msa:	
	python create_repr_lemmas_list.py -config_file config.json -config_name cv_msa_order-v4_red -output_name repr_lemmas_cv_msa.pkl -output_dir conjugation_local/repr_lemmas -pos_type verbal -display_format expanded -bank_dir conjugation_local/banks -bank_name MSA-CV-Ind-Bank
repr_lemmas_pv_glf:	
	python create_repr_lemmas_list.py -config_file config.json -config_name pv_glf_order-v4_red -output_name repr_lemmas_pv_glf.pkl -output_dir conjugation_local/repr_lemmas -pos_type verbal -display_format expanded -bank_dir conjugation_local/banks -bank_name GLF-PV-Bank -lexprob data/glf_verbs_lexprob.tsv
repr_lemmas_iv_glf:	
	python create_repr_lemmas_list.py -config_file config.json -config_name iv_glf_order-v4_red -output_name repr_lemmas_iv_glf.pkl -output_dir conjugation_local/repr_lemmas -pos_type verbal -display_format expanded -bank_dir conjugation_local/banks -bank_name GLF-IV-Bank -lexprob data/glf_verbs_lexprob.tsv
repr_lemmas_cv_glf:	
	python create_repr_lemmas_list.py -config_file config.json -config_name cv_glf_order-v4_red -output_name repr_lemmas_cv_glf.pkl -output_dir conjugation_local/repr_lemmas -pos_type verbal -display_format expanded -bank_dir conjugation_local/banks -bank_name GLF-CV-Bank -lexprob data/glf_verbs_lexprob.tsv
repr_lemmas_pv_egy:	
	python create_repr_lemmas_list.py -config_file config.json -config_name pv_egy_order-v4_red -output_name repr_lemmas_pv_egy.pkl -output_dir conjugation_local/repr_lemmas -pos_type verbal -display_format expanded -bank_dir conjugation_local/banks -bank_name EGY-PV-Bank -lexprob data/egy_verbs_lexprob.tsv
repr_lemmas_iv_egy:	
	python create_repr_lemmas_list.py -config_file config.json -config_name iv_egy_order-v4_red -output_name repr_lemmas_iv_egy.pkl -output_dir conjugation_local/repr_lemmas -pos_type verbal -display_format expanded -bank_dir conjugation_local/banks -bank_name EGY-IV-Bank -lexprob data/egy_verbs_lexprob.tsv
repr_lemmas_cv_egy:	
	python create_repr_lemmas_list.py -config_file config.json -config_name cv_egy_order-v4_red -output_name repr_lemmas_cv_egy.pkl -output_dir conjugation_local/repr_lemmas -pos_type verbal -display_format expanded -bank_dir conjugation_local/banks -bank_name EGY-CV-Bank -lexprob data/egy_verbs_lexprob.tsv
repr_lemmas_nom_msa:	
	python create_repr_lemmas_list.py -config_file config.json -config_name nom_msa_split -output_name repr_lemmas_nom_msa.pkl -output_dir conjugation_local/repr_lemmas -pos_type nominal -display_format expanded -bank_dir conjugation_local/banks -bank_name MSA-Nom-Bank
...
conj_pv_egy:
	python generate_conj_table.py -paradigms config_paradigms.json -repr_lemmas repr_lemmas_pv_egy.pkl -lemmas_dir conjugation_local/repr_lemmas -db XYZ_egy_pv_v1.0_red.db -db_dir db_iterations_local -pos_type verbal -asp p -dialect egy -output_name conj_pv_egy_v1.0.tsv -output_dir conjugation_local/tables
conj_iv_egy:	
	python generate_conj_table.py -paradigms config_paradigms.json -repr_lemmas repr_lemmas_iv_egy.pkl -lemmas_dir conjugation_local/repr_lemmas -db XYZ_egy_iv_v1.0_red.db -db_dir db_iterations_local -pos_type verbal -asp i -dialect egy -output_name conj_iv_egy_v1.0.tsv -output_dir conjugation_local/tables
conj_cv_egy:	
	python generate_conj_table.py -paradigms config_paradigms.json -repr_lemmas repr_lemmas_cv_egy.pkl -lemmas_dir conjugation_local/repr_lemmas -db XYZ_egy_cv_v1.0_red.db -db_dir db_iterations_local -pos_type verbal -asp c -dialect egy -output_name conj_cv_egy_v1.0.tsv -output_dir conjugation_local/tables
...
msa_iv_i_bank_annotation:
	python paradigm_debugging.py -output_name paradigm_debug_iv-i_msa_v1.0.tsv -output_dir conjugation_local/paradigm_debugging -gsheet MSA-IV-Ind -spreadsheet Paradigm-Debugging -bank_dir conjugation_local/banks -bank_name MSA-IV-Ind-Bank -new_conj conjugation_local/tables/conj_iv-i_msa_v1.0.tsv
...
msa_iv_s_bank_annotation:
	python paradigm_debugging.py -output_name paradigm_debug_iv-s_msa_v1.0.tsv -output_dir conjugation_local/paradigm_debugging -gsheet MSA-IV-Sub -spreadsheet Paradigm-Debugging -bank_dir conjugation_local/banks -bank_name MSA-IV-Sub-Bank -new_conj conjugation_local/tables/conj_iv-s_msa_v1.0.tsv
...
msa_iv_j_bank_annotation:
	python paradigm_debugging.py -output_name paradigm_debug_iv-j_msa_v1.0.tsv -output_dir conjugation_local/paradigm_debugging -gsheet MSA-IV-Jus -spreadsheet Paradigm-Debugging -bank_dir conjugation_local/banks -bank_name MSA-IV-Jus-Bank -new_conj conjugation_local/tables/conj_iv-j_msa_v1.0.tsv
...
msa_cv_i_bank_annotation:
	python paradigm_debugging.py -output_name paradigm_debug_cv-i_msa_v1.0.tsv -output_dir conjugation_local/paradigm_debugging -gsheet MSA-CV-Ind -spreadsheet Paradigm-Debugging -bank_dir conjugation_local/banks -bank_name MSA-CV-Ind-Bank -new_conj conjugation_local/tables/conj_cv-i_msa_v1.0.tsv
