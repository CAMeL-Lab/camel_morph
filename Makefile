...
conj_tables_msa:
	...
	python generate_conj_table.py -paradigms conjugation/config_paradigms.json -repr_lemmas conjugation/repr_lemmas/repr_lemmas_iv_msa.csv -db db_iterations/XYZ_iv_v2.0_red.db -asp i -mod i -dialect msa -output_name conjugation/tables/conj_iv-i_msa_v1.0.tsv
	python generate_conj_table.py -paradigms conjugation/config_paradigms.json -repr_lemmas conjugation/repr_lemmas/repr_lemmas_iv_msa.csv -db db_iterations/XYZ_iv_v2.0_red.db -asp i -mod s -dialect msa -output_name conjugation/tables/conj_iv-s_msa_v1.0.tsv
	python generate_conj_table.py -paradigms conjugation/config_paradigms.json -repr_lemmas conjugation/repr_lemmas/repr_lemmas_iv_msa.csv -db db_iterations/XYZ_iv_v2.0_red.db -asp i -mod j -dialect msa -output_name conjugation/tables/conj_iv-j_msa_v1.0.tsv
	python generate_conj_table.py -paradigms conjugation/config_paradigms.json -repr_lemmas conjugation/repr_lemmas/repr_lemmas_cv_msa.csv -db db_iterations/XYZ_cv_v1.0_order-v4_red.db -asp c -dialect msa -output_name conjugation/tables/conj_cv_msa_v1.0.tsv

conj_tables_glf:
	python generate_conj_table.py -paradigms conjugation/config_paradigms.json -repr_lemmas conjugation/repr_lemmas/repr_lemmas_pv_glf.csv -db db_iterations/XYZ_glf_pv_v1.0.db -asp p -dialect glf -output_name conjugation/tables/conj_pv_glf_v1.0.tsv
	python generate_conj_table.py -paradigms conjugation/config_paradigms.json -repr_lemmas conjugation/repr_lemmas/repr_lemmas_iv_glf.csv -db db_iterations/XYZ_glf_iv_v1.0.db -asp i -dialect glf -output_name conjugation/tables/conj_iv_glf_v1.0.tsv
	python generate_conj_table.py -paradigms conjugation/config_paradigms.json -repr_lemmas conjugation/repr_lemmas/repr_lemmas_cv_glf.csv -db db_iterations/XYZ_glf_cv_v1.0.db -asp c -dialect glf -output_name conjugation/tables/conj_cv_glf_v1.0.tsv

conj_tables_egy:
	python generate_conj_table.py -paradigms conjugation/config_paradigms.json -repr_lemmas conjugation/repr_lemmas/repr_lemmas_pv_egy.csv -db db_iterations/XYZ_egy_pv_v1.0.db -asp p -dialect egy -output_name conjugation/tables/conj_pv_egy_v1.0.tsv
	python generate_conj_table.py -paradigms conjugation/config_paradigms.json -repr_lemmas conjugation/repr_lemmas/repr_lemmas_iv_egy.csv -db db_iterations/XYZ_egy_iv_v1.0.db -asp i -dialect egy -output_name conjugation/tables/conj_iv_egy_v1.0.tsv
	python generate_conj_table.py -paradigms conjugation/config_paradigms.json -repr_lemmas conjugation/repr_lemmas/repr_lemmas_cv_egy.csv -db db_iterations/XYZ_egy_cv_v1.0.db -asp c -dialect egy -output_name conjugation/tables/conj_cv_egy_v1.0.tsv
