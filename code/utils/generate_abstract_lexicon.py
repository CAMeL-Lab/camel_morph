...
try:
    from code.utils.utils import add_check_mark_online, consonants_bw
    from code.debugging.download_sheets import download_sheets
except:
    from camel_morph.code.utils.utils import add_check_mark_online, consonants_bw
    from camel_morph.code.debugging.download_sheets import download_sheets
...
if __name__ == "__main__":
    ...
    import code.db_maker_utils as db_maker_utils
