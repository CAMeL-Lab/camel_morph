...
try:
    from code.utils.generate_passive import generate_passive
    from code.utils.generate_abstract_lexicon import generate_abstract_lexicon
except:
    from camel_morph.code.utils.generate_passive import generate_passive
    from camel_morph.code.utils.generate_abstract_lexicon import generate_abstract_lexicon
...
def read_morph_specs(config:Dict, config_name:str) -> Tuple[Dict[str, pd.DataFrame], Dict[str, Tuple[str, int]]]:
    ...
    data_dir: str = config['global']['data-dir']
